...
const formatSummary = (text: string) => {
  return text
    .replace(/\$([^$]+)\$\$/g, '<span class="font-medium text-cyan-200">$1</span>') // Replace $$...$$ with <span>...</span>
    .replace(
      /1@([^@]+)@@/g,
      '<a href="https://halozendsoft.com/" class="font-medium underline   hover:text-cyan-300 focus-visible:text-cyan-300">$1</a>'
    ) // Replace 1@...@@ with <a href="https://halozendsoft.com/">...</a>
    .replace(
      /2@([^@]+)@@/g,
      '<a href="https://dision.tech/" class="font-medium underline  hover:text-cyan-300 focus-visible:text-cyan-300" >$1</a>'
    ) // Replace 2@...@@ with <a href="https://dision.tech/">...</a>
}
